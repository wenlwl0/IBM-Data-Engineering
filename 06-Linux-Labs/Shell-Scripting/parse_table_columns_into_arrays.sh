...
# parses table columns into 3 arrays
...
## Creates a new array as the difference of columns 1 and 2
# initialize array with header
column_3=("column_3")

# Gets the number of lines in each column
...
## Combines the new array with the csv file
# First writes the new array to file, then initializes the file with a header
